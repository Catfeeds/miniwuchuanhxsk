...
<![endif]-->
<link rel="stylesheet" type="text/css" href="/miniwuchuanhxsk/Public/hui/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/miniwuchuanhxsk/Public/hui/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="/miniwuchuanhxsk/Public/hui/lib/Hui-iconfont/1.0.8/iconfont.css" />

<link rel="stylesheet" type="text/css" href="/miniwuchuanhxsk/Public/hui/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/miniwuchuanhxsk/Public/hui/static/h-ui.admin/css/style.css" />


<link href="/miniwuchuanhxsk/Public/hui/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
         ...
         <div>缩略图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_x']) { ?>
                  <img src="/miniwuchuanhxsk/Data/<?php echo $pro_allinfo2[0]['photo_x']; ?>" width="80" height="80" style="margin-bottom: 3px;" />
                  <br />
              <?php } ?>
         ...
         <div>大图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_d']) { ?>
                  <img src="/miniwuchuanhxsk/Data/<?php echo $pro_allinfo2[0]['photo_d']; ?>" width="125" height="125" style="margin-bottom: 3px;" />
                <br />
              <?php } ?>
              ...
              <?php foreach ($img_str as $v) { ?>
               <div>
                <div class="img-err" title="删除" onclick="del_img('<?php echo $v; ?>',this);" style="color:red;cursor: pointer;">×</div>
                 ...
                 <?php }else{ ?>
                  <img src="<?php echo '/miniwuchuanhxsk/Data/'.$v; ?>" width="125" height="125">
                 <?php } ?>
               </div>
              <?php } ?>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/static/h-ui/js/H-ui.min.js"></script> 
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
  ...
  var uploader = WebUploader.create({
    auto: true,
    swf: '/miniwuchuanhxsk/Public/hui/lib/webuploader/0.1.5/Uploader.swf',
  
    // 文件接收服务端。
    server: '/miniwuchuanhxsk/Public/hui/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/miniwuchuanhxsk/Public/hui/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
