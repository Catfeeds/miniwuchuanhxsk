...
<div class="aaa_pts_show_1">【 KTV套餐管理 】</div>

<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('index');?>">全部KTV套餐</a></div>
       <div class="aaa_pts_4"><a href="<?php echo U('add');?>">添加KTV套餐</a></div>
    </div>
    <div class="aaa_pts_3">
         ...
         <!-- 遍历 -->
          <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td>
              ...
              <a href="<?php echo U('add');?>?id=<?php echo ($v["id"]); ?>&page=<?php echo ($page); ?>&shop_id=<?php echo ($shop_id); ?>">修改</a> |
