	   ...
	   <dl id="menu-article">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="<?php echo U('More/indeximg');?>" data-title="前台管理" href="javascript:void(0)">首页图片管理</a></li>
                ...
                <ul>
                   <!--  <li><a data-href="<?php echo U('Hotel/add');?>" data-title="添加酒店房间" href="javascript:void(0)">添加酒店房间</a></li>
                    ...
                    <li><a data-href="<?php echo U('Ktvmanage/index');?>" data-title="KTV套餐管理" href="javascript:void(0)">KTV套餐管理</a></li> -->
                     <li><a data-href="<?php echo U('Manage/add');?>" data-title="添加其他套餐" href="javascript:void(0)">添加套餐</a></li>
                    <li><a data-href="<?php echo U('Manage/index');?>" data-title="其他套餐管理" href="javascript:void(0)">套餐管理</a></li>
                </ul>
        </dd>
    </dl>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/miniwuchuanhxsk/Public/hui/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
