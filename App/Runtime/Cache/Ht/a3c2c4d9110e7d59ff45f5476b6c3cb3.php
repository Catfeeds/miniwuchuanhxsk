...
<div class="aaa_pts_show_1">【 酒店产品管理 】</div>

<div class="aaa_pts_show_2">
    <div>
       <div class="aaa_pts_4"><a href="<?php echo U('Hotel/index');?>">全部酒店产品</a></div>
       <div class="aaa_pts_4"><a href="<?php echo U('Hotel/add');?>">添加酒店产品</a></div>
    </div>
    <div class="aaa_pts_3">
		<form action="<?php echo U('Hotel/add');?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
		<ul class="aaa_pts_5">
			<li>
      ...
      <!-- <li>
        ...
        <div>
          ...
          <input type="button" value="选择商家" class="aaa_pts_web_3" style="margin-left:15px;" onclick="win_open('<?php echo U('Shangchang/index');?>?type=xz&tid=1',1280,800)">
        </div>
       </li> -->
        ...
        <li>
          ...
          <div>
            ...
            <img src="<?php echo '/miniwuchuanhxsk/Data/'.$v; ?>" width="120" height="50">
          </div>
          <?php } ?>
        </li>
        <?php } ?>
        ...
        <li>
         ...
         <li>
            <div class="d1">上网:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="wifi" id="wifi" value="<?php echo ($pro_allinfo["wifi"]); ?>"/>
            </div><label class="remarks">&nbsp;* 无线WiFi、宽带</label>
         </li>
         <li>
            <div class="d1">独立卫浴:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="bathroom" id="bathroom" value="<?php echo ($pro_allinfo["bathroom"]); ?>"/><label class="remarks">&nbsp;* 独立、公用</label>
            </div>
         </li>
         <li>
            <div class="d1">窗户:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="windows" id="windows" value="<?php echo ($pro_allinfo["windows"]); ?>"/><label class="remarks">&nbsp;* 内窗、外窗、无窗</label>
            </div>
         </li>
         <li>
            <div class="d1">可住人数:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="people" id="people" value="<?php echo ($pro_allinfo["people"]); ?>"/><label class="remarks">&nbsp;* 填入数字格式</label>
            </div>
         </li>
         <li>
            <div class="d1">楼层:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="floor" id="floor" value="<?php echo ($pro_allinfo["floor"]); ?>"/>
            </div><label class="remarks">&nbsp;* 房间所在楼层</label>
         </li>
         <li>
            <div class="d1">房间面积:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="area" id="area" value="<?php echo ($pro_allinfo["area"]); ?>"/>
            </div>
         </li>
         <li>
            <div class="d1">床型:</div>
            <div>
              <input class="inp_1" style="width:150px;" name="bedtype" id="bedtype" value="<?php echo ($pro_allinfo["bedtype"]); ?>"/>
            </div><label class="remarks">&nbsp;* 大床 1.8X2.0米 1张</label>
         </li>
         <li>
            <div class="d1">早餐:</div>
            <div>
              <input class="inp_1" style="width:100px;" name="breakfast" id="breakfast" value="<?php echo ($pro_allinfo["breakfast"]); ?>"/><label class="remarks">&nbsp;* 不含早、含早、双份早餐</label>
            </div>
         </li>
