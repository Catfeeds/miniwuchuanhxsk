...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
      ...
      <ul class="aaa_pts_5">
         ...
         <li>
            ...
            <div>
               <select class="inp_1" id="position" name="position">
                  ...
                  <option value="1" <?php echo $adv_info['position']==1 ? 'selected="selected"' : NULL; ?>>&nbsp;- 小程序首页轮播</option>
                  <option value="2" <?php echo $adv_info['position']==2 ? 'selected="selected"' : NULL; ?>>&nbsp;- 吃喝玩乐首页轮播</option>
                  <option value="3" <?php echo $adv_info['position']==3 ? 'selected="selected"' : NULL; ?>>&nbsp;- 点餐首页轮播</option>
               </select>
            </div>
         </li>
		     <!-- <li>
            ...
            <div>
               <select class="inp_1" id="type" name="type">
                  ...
                  <option value="product" <?php echo $adv_info['type']=='product' ? 'selected="selected"' : NULL; ?>>产品</option>
                  <option value="partner" <?php echo $adv_info['type']=='partner' ? 'selected="selected"' : NULL; ?>>店铺</option>
               </select>
            </div>
         </li> -->
         <!-- <li>
        ...
        <span style="color:red;font-size: 12px;margin-left:1%;">所有轮播图大小：600*300；</span>
         <li data-index="" style="margin-top:10px;">
            ...
            <div>
             <input type="hidden" name="photo" id="photo" value="<?php echo $adv_info['photo']; ?>"/>
              ...
              <img src="/miniwuchuanhxsk/Data/<?php echo $adv_info['photo']; ?>" width="200" height="100" /><br /><br />
              <?php } ?>
