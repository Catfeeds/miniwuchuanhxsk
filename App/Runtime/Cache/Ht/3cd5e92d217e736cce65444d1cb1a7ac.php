    ...
    <div class="aaa_pts_3">
      ...
      <table class="pro_3">
         ...
         <tbody id="news_option">
          ...
          <td><img src="/miniwuchuanhxsk/Data/<?php echo ($adv["photo"]); ?>" width="120px" height="60px"></td>
          <td><?php echo ($adv["name"]); ?></td>
          <td>
              <?php if($adv["position"] == 1): ?><span class="label succ">小程序首页轮播</span>
              <?php elseif($adv["position"] == 2): ?><span class="label succ">吃喝玩乐首页轮播</span>
              <?php else: ?>
              <span class="label succ">点餐首页轮播</span><?php endif; ?>
          </td>
          <td class="obj_1">
